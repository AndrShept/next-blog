  ...
  return (
    <section>
      <div className='grid grid-cols-2  mb-10  items-center gap-8'>
        ...
        <div
          className='border-2 rounded-lg border-[#bbb] h-[400px] w-[400px] bg-center  bg-cover  bg-[url(https://images.unsplash.com/photo-1579783901586-d88db74b4fe4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=748&q=80)]'
          href='blog/id'
        >
          </div>
      </div>
